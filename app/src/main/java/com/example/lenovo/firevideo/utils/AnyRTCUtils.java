...
public enum  AnyRTCUtils {
    ...
    public static String getErrString(int value) {
        if (value == AnyRTC_OK.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_ok);
        } else if (value == AnyRTC_UNKNOW.getValue()) {
            return FireVideoApp.App().getString(R.string.str_unknow_exception);
        } else if (value == AnyRTC_EXCEPTION.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_exception);
        } else if (value == AnyRTC_NET_ERR.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_net_err);
        } else if (value == AnyRTC_LIVE_ERR.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_live_err);
        } else if (value == AnyRTC_BAD_REQ.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_bad_req);
        } else if (value == AnyRTC_AUTH_FAIL.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_auth_fail);
        } else if (value == AnyRTC_NO_USER.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_no_user);
        } else if (value == AnyRTC_SQL_ERR.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_sql_err);
        } else if (value == AnyRTC_ARREARS.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_arrears);
        } else if (value == AnyRTC_LOCKED.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_locked);
        } else if (value == AnyRTC_FORCE_EXIT.getValue()) {
            return FireVideoApp.App().getString(R.string.str_anyrtc_force_exit);
        } else {
            return "";
        }
    }
