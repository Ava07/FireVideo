package com.example.lenovo.firevideo.permission;
...
public class PermissionActivity extends AppCompatActivity {
    ...
    private com.example.lenovo.firevideo.permission.PermissionsUtil.TipInfo tipInfo;
    ...
    @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (ser == null) {
            tipInfo = new com.example.lenovo.firevideo.permission.PermissionsUtil.TipInfo(defaultTitle, defaultContent, defaultCancel, defaultEnsure);
        } else {
            tipInfo = (com.example.lenovo.firevideo.permission.PermissionsUtil.TipInfo)ser;
        }
    ...
    @Override protected void onResume() {
        super.onResume();
        if (isRequireCheck) {
            if (com.example.lenovo.firevideo.permission.PermissionsUtil.hasPermission(this, permission)) {
                permissionsGranted();
            } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_REQUEST_CODE && com.example.lenovo.firevideo.permission.PermissionsUtil.isGranted(grantResults)
                && com.example.lenovo.firevideo.permission.PermissionsUtil.hasPermission(this, permissions)) {
            permissionsGranted();
        } else if (showTip){
    ...
    private void showMissingPermissionDialog() {
        ...
        builder.setPositiveButton(TextUtils.isEmpty(tipInfo.ensure) ? defaultEnsure : tipInfo.ensure, new DialogInterface.OnClickListener() {
            @Override public void onClick(DialogInterface dialog, int which) {
                com.example.lenovo.firevideo.permission.PermissionsUtil.gotoSetting(PermissionActivity.this);
            }
        });
    ...
    private void permissionsDenied() {
        com.example.lenovo.firevideo.permission.PermissionListener listener = com.example.lenovo.firevideo.permission.PermissionsUtil.fetchListener(key);
        if (listener != null) {
    ...
    protected void onDestroy() {
        com.example.lenovo.firevideo.permission.PermissionsUtil.fetchListener(key);
        super.onDestroy();
    }
