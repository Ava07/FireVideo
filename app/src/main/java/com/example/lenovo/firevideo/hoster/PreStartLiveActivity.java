 ...
 * 直播信息输入页面
 */
public class PreStartLiveActivity extends com.example.lenovo.firevideo.BaseActivity implements MaterialSpinner.OnItemSelectedListener {
    ...
    String anyrtcId = FireVideoApp.getAnyRTCId();
