 ...
 * 音频游客界面
 */
public class AudioGuestActivity extends com.example.lenovo.firevideo.BaseActivity implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    public String getUserData() {
        ...
        try {
            ...
            user.put("nickName", FireVideoApp.getNickName());
    ...
    private void showChatLayout() {
        ...
        keyboardDialogFragment.setEdittextListener(new KeyboardDialogFragment.EdittextListener() {
            ...
            public void setTextStr(String text) {
                addChatMessageList(new MessageBean(1, FireVideoApp.getNickName(), text, ""));
                mGuestKit.sendUserMessage(0, FireVideoApp.getNickName(), "", text);
            }
