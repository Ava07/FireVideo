...
public class NetHttp {
    ...
    public <T> void request(int what, Request<T> request, final com.example.lenovo.firevideo.utils.ResultListener<T> listener) {
        queue.add(what, request, new SimpleResponseListener<T>() {
            ...
            public void onFailed(int what, Response<T> response) {
                com.example.lenovo.firevideo.utils.ToastUtil.show("请检查网络");
